 ...
 */
  module.factory(
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/clients/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Clients.orders.findById() instead.
            "prototype$__findById__orders": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/clients/:id/orders/:fk",
              method: "GET",
            },

            // INTERNAL. Use Clients.orders.destroyById() instead.
            ...
            // INTERNAL. Use Clients.orders.updateById() instead.
            ...
            // INTERNAL. Use Clients.orders() instead.
            "prototype$__get__orders": {
              isArray: true,
              url: urlBase + "/clients/:id/orders",
              method: "GET",
            },

            // INTERNAL. Use Clients.orders.create() instead.
            "prototype$__create__orders": {
              url: urlBase + "/clients/:id/orders",
              method: "POST",
            },

            // INTERNAL. Use Clients.orders.destroyAll() instead.
            "prototype$__delete__orders": {
              url: urlBase + "/clients/:id/orders",
              method: "DELETE",
            },

            // INTERNAL. Use Clients.orders.count() instead.
            "prototype$__count__orders": {
              url: urlBase + "/clients/:id/orders/count",
              method: "GET",
            },
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Clients#updateAttributes
             * @methodOf lbServices.Clients
             *
             * @description
             *
    ...
    /**
     * @ngdoc object
     * @name lbServices.Clients.orders
     * @header lbServices.Clients.orders
     * @object
     * @description
     *
     * The object `Clients.orders` groups methods
     * manipulating `Orders` instances related to `Clients`.
     *
     * Call {@link lbServices.Clients#orders Clients.orders()}
     ...
     */
        ...
        R.orders = function() {
          ...
          var action = TargetResource["::get::Clients::orders"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clients.orders#count
             * @methodOf lbServices.Clients.orders
             *
             * @description
             *
             * Counts orders of clients.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.orders.count = function() {
          var TargetResource = $injector.get("Orders");
          var action = TargetResource["::count::Clients::orders"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clients.orders#create
             * @methodOf lbServices.Clients.orders
             *
             * @description
             *
        ...
        R.orders.create = function() {
          var TargetResource = $injector.get("Orders");
          var action = TargetResource["::create::Clients::orders"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clients.orders#createMany
             * @methodOf lbServices.Clients.orders
             *
             * @description
             *
        ...
        R.orders.createMany = function() {
          var TargetResource = $injector.get("Orders");
          var action = TargetResource["::createMany::Clients::orders"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clients.orders#destroyAll
             * @methodOf lbServices.Clients.orders
             *
             * @description
             *
        ...
        R.orders.destroyAll = function() {
          var TargetResource = $injector.get("Orders");
          var action = TargetResource["::delete::Clients::orders"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clients.orders#destroyById
             * @methodOf lbServices.Clients.orders
             *
             * @description
             *
        ...
        R.orders.destroyById = function() {
          var TargetResource = $injector.get("Orders");
          var action = TargetResource["::destroyById::Clients::orders"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clients.orders#findById
             * @methodOf lbServices.Clients.orders
             *
             * @description
             *
        ...
        R.orders.findById = function() {
          var TargetResource = $injector.get("Orders");
          var action = TargetResource["::findById::Clients::orders"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clients.orders#updateById
             * @methodOf lbServices.Clients.orders
             *
             * @description
             *
        ...
        R.orders.updateById = function() {
          var TargetResource = $injector.get("Orders");
          var action = TargetResource["::updateById::Clients::orders"];
          return action.apply(R, arguments);
        };
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/orders/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orders#prototype$patchAttributes
             * @methodOf lbServices.Orders
             *
             * @description
             *
            ...
            // INTERNAL. Use Clients.orders.createMany() instead.
            "::createMany::Clients::orders": {
              isArray: true,
              url: urlBase + "/clients/:id/orders",
              method: "POST",
            },
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orders#updateAttributes
             * @methodOf lbServices.Orders
             *
             * @description
             *
